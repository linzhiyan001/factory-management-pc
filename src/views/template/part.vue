    ...
    <div class="app-container">
        ...
        <div class="content">
            ...
            <div class="table">
                <el-table :data="dataList" border>
                    ...
                    <el-table-column prop="color" label="部位" align="center"></el-table-column>
        ...
        <el-dialog title="部位" :visible.sync="dialogVisible" center width="500px">
            <el-form :model="detailForm" :rules="rules" ref="ruleForm" label-width="100px" class="detailForm">
                <el-form-item label="部位" prop="color" style="width: 100%;">
                    <el-input v-model="detailForm.color"></el-input>
                </el-form-item>
            </el-form>
