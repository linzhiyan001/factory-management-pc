<template>
    <div class="app-container">
        ...
        <div class="content">
            <div class="lgm-search">
                <el-form ref="form" :model="searchParams" label-width="100px" class="search-form">
                    ...
                    <el-form-item label="款号">
                        <el-input v-model="searchParams.code" placeholder="请输入订单号、款式编号、款式、颜色"></el-input>
                    </el-form-item>
                    <el-row>
            ...
            <div class="info">
                <div class="item">
                    <p class="title">出库数量</p>
                    <div class="box">
                        0
                    </div>
                </div>
                <div class="item">
                    <p class="title">入库数量</p>
                    <div class="box">
                        5
                    </div>
                </div>
                <div class="item">
                    <p class="title">库存数量</p>
                    <div class="box">
                        5
                    </div>
                </div>
            ...
            <div class="table">
                <el-table :data="dataList" border>
                    ...
                    <el-table-column prop="number" label="出库单号" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="code" label="产品编码" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="cpfl" label="产品分类" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="cpmc" label="产品名称" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="size" label="尺码" align="center" width="100"></el-table-column>
                    <el-table-column prop="color" label="颜色" align="center" width="100"></el-table-column>
                    <el-table-column prop="ggxh" label="规格型号" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="dw" label="单位" align="center" width="100"></el-table-column>
                    <el-table-column prop="kcsl" label="库存数量" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="ckdj" label="出库单价" align="center" min-width="170"></el-table-column>
                    <el-table-column prop="cksl" label="出库数量" align="center" min-width="170"></el-table-column>

                    <el-table-column prop="time" label="出库时间" align="center" min-width="120"></el-table-column>
